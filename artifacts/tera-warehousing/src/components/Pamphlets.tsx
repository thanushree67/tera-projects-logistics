...
export function Pamphlets({ onOpen }: Props) {
  return (
    <motion.div
      ...
      transition={{ duration: 0.75, ease: [0.2, 0.8, 0.2, 1], delay: 0.15 }}
    ...
    >
      ...
      {/* Premium thumbnail — fills its column, clicks to expand */}
      <motion.button
        onClick={onOpen}
        whileHover={{ y: -4, scale: 1.015 }}
        whileTap={{ scale: 0.975 }}
        transition={{ type: "spring", stiffness: 300, damping: 24 }}
        className="group relative w-full cursor-pointer overflow-hidden rounded-sm border border-cream/15 bg-card focus:outline-none focus-visible:ring-2 focus-visible:ring-teal"
        style={{
          boxShadow:
            "0 24px 56px -16px oklch(0 0 0 / 0.65), 0 0 0 1px oklch(0.97 0.01 95 / 0.06)",
        }}
      ...
      >
        ...
        <span
          ...
          style={{
            boxShadow:
              "inset 0 0 0 1px oklch(0.72 0.10 195 / 0.5), 0 0 40px -8px oklch(0.72 0.10 195 / 0.28)",
          }}
        />
        ...
        <span
          ...
          style={{
            background:
              "linear-gradient(to top, oklch(0.22 0.07 252 / 0.9) 0%, transparent 100%)",
          }}
        />
